  ...
  return (
    <div className="flex flex-col items-center justify-between h-full p-8 a4m__body rounded-lg shadow-2xl">
      <div className="text-center">
        ...
        <p className="text-lg text-yellow-400 mt-2 animate-pulse">{t('call.incomingCall')}</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 w-full max-w-md mt-10">
        <div className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm text-gray-300">{t('call.reject')}</span>
        </div>

        <div className="flex flex-col items-center">
          <ActionButton
            onClick={onAnswerWithAnswerForMe}
            ariaLabel={t('call.answerWithA4M')}
          ...
          <span className="mt-2 text-sm text-center text-gray-300">{t('call.answerWithA4M')}</span>
        </div>
        
        <div className="flex flex-col items-center">
          <ActionButton
            onClick={onAnswer}
            ariaLabel={t('call.answer')}
          ...
          <span className="mt-2 text-sm text-gray-300">{t('call.answer')}</span>
        </div>
      </div>
    </div>
  );
